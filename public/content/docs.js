...
I am always tinkering, so parts of this site may be outdated, broken, or mid-experiment.
`,
  },
  about: {
    ...
    markdown: `
# PROFILE.md
I am a Product Manager focused on building useful products and durable systems.
...
# INDEX.md
## Current Focus
Exploring practical AI applications in payment workflows.
The shift toward voice as a primary interface.



Select a project below to view more detail.
`,
  },
  articles: {
    command: "cat articles/INDEX.md",
    markdown: `
# INDEX.md
## Articles
