...
// .wrangler/tmp/bundle-xB5H8U/strip-cf-connecting-ip-header.js
...
// .wrangler/tmp/pages-LZ0dsd/functionsWorker-0.40747395998704905.mjs
...
var init_strip_cf_connecting_ip_header = __esm({
  "../.wrangler/tmp/bundle-le6W3Y/strip-cf-connecting-ip-header.js"() {
...
__name(toCityResponse, "toCityResponse");
var FEEDS;
var onRequest;
var init_cities = __esm({
  "api/cities.ts"() {
    init_functionsRoutes_0_06815698363661182();
    ...
    __name2(toCityResponse, "toCityResponse");
    onRequest = /* @__PURE__ */ __name2(async () => {
      return new Response(
        JSON.stringify({
...
var require_xmlNode = __commonJS({
  "../node_modules/fast-xml-parser/src/xmlparser/xmlNode.js"(exports, module) {
    ...
    init_functionsRoutes_0_06815698363661182();
    init_strip_cf_connecting_ip_header();
    var XmlNode = /* @__PURE__ */ __name(class {
      constructor(tagname) {
...
var require_OrderedObjParser = __commonJS({
  "../node_modules/fast-xml-parser/src/xmlparser/OrderedObjParser.js"(exports, module) {
    ...
    var OrderedObjParser = /* @__PURE__ */ __name(class {
      constructor(options) {
    ...
    __name2(OrderedObjParser, "OrderedObjParser");
    ...
    var replaceEntitiesValue = /* @__PURE__ */ __name2(function(val) {
...
var require_XMLParser = __commonJS({
  "../node_modules/fast-xml-parser/src/xmlparser/XMLParser.js"(exports, module) {
    ...
    var XMLParser2 = /* @__PURE__ */ __name(class {
      constructor(options) {
...
function textOf(value) {
  ...
  if (Array.isArray(value))
    return value.map(textOf).join(" ").trim();
  if (typeof value === "object") {
    const record = value;
    if ("#text" in record)
      return textOf(record["#text"]);
    if ("__cdata" in record)
      return textOf(record["__cdata"]);
...
function normalizeItems(items) {
  ...
  return list.map((item) => {
    ...
    const categories = rawCategories.map((cat) => textOf(cat).trim()).filter(Boolean);
    if (!link && description) {
      const match2 = description.match(/https?:\/\/www\.missoulaevents\.net\/[^\s"'<]+/i);
      if (match2)
        link = match2[0];
    }
...
async function fetchFeed(url) {
  ...
  if (rssItems)
    return normalizeItems(rssItems);
  if (atomItems)
    return normalizeItems(atomItems);
  return [];
}
...
function isBlockedEvent(event) {
  ...
  if (TITLE_BLOCKLIST.some((term) => title.includes(term)))
    return true;
...
__name(isBlockedEvent, "isBlockedEvent");
function getFeedUrl(city, category) {
  const cityConfig = FEEDS[city];
  if (!cityConfig)
    return null;
  const categoryUrl = cityConfig.categories[category];
  return categoryUrl || null;
}
__name(getFeedUrl, "getFeedUrl");
...
function filterByDay(events, targetOffsetDays, timeZone) {
  ...
  return events.filter((event) => {
    ...
    if (event.link) {
      const match2 = event.link.match(/\/(\d{2})\/(\d{2})\/(\d{4})\//);
      if (match2) {
        const [_, mm, dd, yyyy] = match2;
...
__name(filterByDay, "filterByDay");
var import_fast_xml_parser;
var BASE_URL;
var parser;
var TITLE_BLOCKLIST;
var VENUE_BLOCKLIST;
var TIMEZONE_BY_CITY;
var onRequest2;
var init_events = __esm({
  "api/events.ts"() {
    ...
    init_cities();
    BASE_URL = "https://www.missoulaevents.net";
    parser = new import_fast_xml_parser.XMLParser({
      ignoreAttributes: false,
      attributeNamePrefix: "",
      allowBooleanAttributes: true
    });
    __name2(textOf, "textOf");
    __name2(normalizeItems, "normalizeItems");
    ...
    __name2(isBlockedEvent, "isBlockedEvent");
    __name2(getFeedUrl, "getFeedUrl");
    TIMEZONE_BY_CITY = {
      missoula: "America/Denver"
    };
    __name2(toDateKey, "toDateKey");
    __name2(filterByDay, "filterByDay");
    onRequest2 = /* @__PURE__ */ __name2(async ({ request }) => {
      ...
      try {
        ...
        const filteredEvents = isToday ? filterByDay(events, 0, timeZone) : isTomorrow ? filterByDay(events, 1, timeZone) : events;
        const payload = {
          city,
          category,
          source: feedUrl,
...
var routes;
var init_functionsRoutes_0_06815698363661182 = __esm({
  "../.wrangler/tmp/pages-LZ0dsd/functionsRoutes-0.06815698363661182.mjs"() {
    init_cities();
    init_events();
    routes = [
      {
...
// .wrangler/tmp/bundle-xB5H8U/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-xB5H8U/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.40747395998704905.js.map
